...
def prepare_data(args):
    ...
    for i in range(len(train_loaders)):
        ...
        # 这里len(train_loaders[i].dataset.dataset)=全集长度，len(train_loaders[i].dataset)=子集长度
...
# net_dataidx_map_train = {0:[0,1,2,...,len(amazon_train_loader)-1], 1:[0,1,2,...,len(caltech_train_loader)-1], ...}
