...
#           --n_parties 4 --cls_num 10 --device cpu \
...
# bp test
python fwd_main_tc.py  --pretrained_dir checkpoints/imagenet21k_ViT-B_16.npz --model_type ViT-B_16 \
        --partition noniid-labeluni --n_parties 20 --beta 0.01 --cls_num 10 --device cuda:0 \
        --batch_size 64 --comm_round 70  --test_round 30 --sample 0.25 --alg SGPT\
        --dataset cifar100 --lr 0.01 --epochs 1 \
        --check_layer_id 20 --bptrain --var_threshold 0.1

# python fwd_main_tc.py  --pretrained_dir checkpoints/imagenet21k_ViT-B_16.npz --model_type ViT-B_16 \
#         --partition noniid-labeluni --n_parties 20 --beta 0.01 --cls_num 10 --device cuda:0 \
#         --batch_size 40 --comm_round 70  --test_round 30 --sample 0.25 --alg SGPT\
#         --dataset cifar100 --lr 0.001 --epochs 1 -N 10 \
#         --peftmode adapter --check_layer_id 20 --fwdtrain_grad --var_threshold 0.1